...
public class ActivatePortalGenPacket extends SPGamePacket {
    Zone zone;
    IntVector3 genPosition = new IntVector3();
    public ActivatePortalGenPacket(){}
    public ActivatePortalGenPacket(BlockEntityPortalGenerator portalGenerator){
